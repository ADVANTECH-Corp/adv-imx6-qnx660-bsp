...
main(int argc, char **argv, char **envv)
{
	...
	while ((opt = getopt(argc, argv, COMMON_OPTIONS_STRING "bmnsW")) != -1) {
		switch (opt) {
			case 'b':
				enable_bt = TRUE;
				break;
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/startup/boards/imx6x/smart-device/main.c $ $Rev: 765681 $")
#endif
